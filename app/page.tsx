...
const workLists = [
  {
    title: "dextbird",
    description: "dextbirdはdiscord.pyの音声拡張ライブラリです。主にパフォーマンスを向上させたいときに使います(たぶん)",
    url: "http://github.com/tuna2134/discord-ext-songbird",
    image: "/no-image.png"
  },
  {
    title: "voicevox-client",
    description: "voicevox-clientはVoiceVoxのAPIををPythonで使いやすくしました。現在書き直し中",
    url: "https://github.com/voicevox-client/python",
    image: "/no-image.png"
  },
  {
    title: "清夏",
    description: "清夏はPythonで書いた、メッセージ専門のdiscord botです。いろいろな機能があります。",
...
export default function Home() {
  return (
    <div>
      ...
      <main className="w-full max-w-4xl lg:max-w-6xl mx-auto px-4">
        <div className='py-6'>
